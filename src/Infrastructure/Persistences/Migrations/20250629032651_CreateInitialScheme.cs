        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    updated_by = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "roles",
                columns: new[] { "Id", "concurrency_stamp", "created_at", "created_by", "name", "normalized_name", "status", "updated_at", "updated_by" },
                values: new object[,]
                {
                    { new Guid("28c879e4-46e1-4186-b052-05a74320ab01"), "00000000-0000-0000-0000-000000000000", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "system@veahome.com.pe", "Administrator", "ADMINISTRATOR", "Active", null, null },
                    { new Guid("28c879e4-46e1-4186-b052-05a74320ab02"), "00000000-0000-0000-0000-000000000000", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "system@veahome.com.pe", "Client", "CLIENT", "Active", null, null }
                });
